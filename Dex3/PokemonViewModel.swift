    ...
    private func getPokemon() async {
        ...
        do {
            guard var pokedex = try await controller.fetchAllPokemon() else {
                print("Pokemon already exist in the database.")
                status = .success
                return
            }
            ...
            for pokemon in pokedex {
                ...
                newPokemon.animatedFront = pokemon.animatedFront
                newPokemon.animatedBack = pokemon.animatedBack
                newPokemon.animatedFrontShiny = pokemon.animatedFrontShiny
                newPokemon.animatedBackShiny = pokemon.animatedBackShiny
